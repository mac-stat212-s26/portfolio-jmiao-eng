...
mn_cities <- st_read("/Users/myq72/Documents/GitHub/portfolio-jmiao-eng/ica/Data/shp_loc_pop_centers")
mn_water <- st_read("/Users/myq72/Documents/GitHub/portfolio-jmiao-eng/ica/Data/shp_water_lakes_rivers")
```
...
names(mn_counties)[names_counties == "Minnesota"] <- c("state_name1", "state_name2")
```
...
tc_map_zoom.png <- png("/Users/myq72/Documents/GitHub/portfolio-jmiao-eng/ica/figures", width = 10000, height = 10000)
